...
@"reflect/types.type:basic:complex128" = linkonce_odr constant %runtime.typecodeID { %runtime.typecodeID* null, i32 0, %runtime.interfaceMethodInfo* null, %runtime.typecodeID* @"reflect/types.type:pointer:basic:complex128" }
@"reflect/types.type:pointer:basic:complex128" = linkonce_odr constant %runtime.typecodeID { %runtime.typecodeID* @"reflect/types.type:basic:complex128", i32 0, %runtime.interfaceMethodInfo* null, %runtime.typecodeID* null }
...
define hidden void @main.newScalar(i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %new = call i8* @runtime.alloc(i32 1, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new, i8** @main.scalar1, align 4
  %new1 = call i8* @runtime.alloc(i32 4, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new1, i8** bitcast (i32** @main.scalar2 to i8**), align 4
  %new2 = call i8* @runtime.alloc(i32 8, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new2, i8** bitcast (i64** @main.scalar3 to i8**), align 4
  %new3 = call i8* @runtime.alloc(i32 4, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new3, i8** bitcast (float** @main.scalar4 to i8**), align 4
  ret void
}

define hidden void @main.newArray(i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %new = call i8* @runtime.alloc(i32 3, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new, i8** bitcast ([3 x i8]** @main.array1 to i8**), align 4
  %new1 = call i8* @runtime.alloc(i32 71, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new1, i8** bitcast ([71 x i8]** @main.array2 to i8**), align 4
  %new2 = call i8* @runtime.alloc(i32 12, i8* nonnull inttoptr (i32 67 to i8*), i8* undef, i8* null)
  store i8* %new2, i8** bitcast ([3 x i8*]** @main.array3 to i8**), align 4
  ret void
}

define hidden void @main.newStruct(i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %new = call i8* @runtime.alloc(i32 0, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new, i8** bitcast ({}** @main.struct1 to i8**), align 4
  %new1 = call i8* @runtime.alloc(i32 8, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  store i8* %new1, i8** bitcast ({ i32, i32 }** @main.struct2 to i8**), align 4
  %new2 = call i8* @runtime.alloc(i32 248, i8* bitcast ({ i32, [8 x i8] }* @"runtime/gc.layout:62-2000000000000001" to i8*), i8* undef, i8* null)
  store i8* %new2, i8** bitcast ({ i8*, [60 x i32], i8* }** @main.struct3 to i8**), align 4
  ret void
}

define hidden %runtime.funcValue* @main.newFuncValue(i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %new = call i8* @runtime.alloc(i32 8, i8* nonnull inttoptr (i32 197 to i8*), i8* undef, i8* null)
  %0 = bitcast i8* %new to %runtime.funcValue*
  ret %runtime.funcValue* %0
}

define hidden void @main.makeSlice(i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %makeslice = call i8* @runtime.alloc(i32 5, i8* nonnull inttoptr (i32 3 to i8*), i8* undef, i8* null)
  ...
  %makeslice1 = call i8* @runtime.alloc(i32 20, i8* nonnull inttoptr (i32 67 to i8*), i8* undef, i8* null)
  ...
  %makeslice3 = call i8* @runtime.alloc(i32 60, i8* nonnull inttoptr (i32 71 to i8*), i8* undef, i8* null)
...
define hidden %runtime._interface @main.makeInterface(double %v.r, double %v.i, i8* %context, i8* %parentHandle) unnamed_addr {
entry:
  %0 = call i8* @runtime.alloc(i32 16, i8* null, i8* undef, i8* null)

...
// Peripheral abstraction layer for the stm32wl55
...
const APB1_TIM_FREQ = 48000000
const APB2_TIM_FREQ = 48000000
...
var (
	t = (*stm32.TIM_Type)(unsafe.Pointer(stm32.TIM1))
	//t = stm32.TIM1
	...
	TIM1 = TIM{
		...
		Channels: [4]TimerChannel{
			TimerChannel{Pins: []PinFunction{{PA8, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA9, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA10, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA11, 0b01}}},
		},
	...
	TIM2 = TIM{
		...
		Device:         t,
		Channels: [4]TimerChannel{
			TimerChannel{Pins: []PinFunction{{PA0, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA1, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA2, 0b01}}},
			TimerChannel{Pins: []PinFunction{{PA3, 0b01}}},
		},
...
func (t *TIM) registerOCInterrupt() interrupt.Interrupt {
	...
	case &TIM2:
		return interrupt.New(stm32.IRQ_TIM1_CC, TIM2.handleOCInterrupt)
	}
